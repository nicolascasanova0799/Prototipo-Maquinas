...
| Integración pendiente con aplicación móvil complementaria | Los resultados de auditoría de terreno aún no se intercambian con el panel web | Definir contrato canónico para presencia, condición, evidencia, ubicación y solicitudes antes de la implementación real |
